...
// // // import * as atlas from "azure-maps-control"; // Azure Maps SDK
...
// // //     if (!subscriptionKey) {
// // //       console.error("Azure Maps key missing. Add it to .env file.");
// // //       return;
// // //     }
// // //     useEffect(() => {
// // //   fetch("http://127.0.0.1:5000/camera-locations")
// // //     .then(res => res.json())
// // //     .then(data => setCameraLocations(data));
// // // }, []);
...
// // //         // Example: Add a static camera marker
...
// // //       {/* Azure Maps Section */}
// // //       <section className="bg-white p-6 rounded-2xl shadow-md">
// // //         <h2 className="text-xl font-semibold mb-4">Camera Map</h2>
// // //         <div
// // //           ref={mapRef}
...
// //   // Refs for map container + instance
// //   const mapRef = useRef(null);
// //   const mapInstance = useRef(null);
...
// //     } catch (error) {
// //       console.error("Error starting model:", error);
// //       alert("Error starting surveillance. Check console for details.");
// //     }
// //   };
...
// //     } catch (error) {
// //       console.error("Error stopping model:", error);
// //       alert("Error stopping surveillance. Check console for details.");
// //     }
// //   };

// //   // Fetch camera locations from Flask
// //   useEffect(() => {
...
// //     // Only initialize once and when mapRef is available
// //     if (!mapInstance.current && mapRef.current) {
// //       try {
// //         const map = new atlas.Map(mapRef.current, {
// //           center: [80.2707, 13.0827], // Chennai [longitude, latitude]
// //           zoom: 12,
// //           authOptions: {
// //             authType: "subscriptionKey",
// //             subscriptionKey: subscriptionKey,
// //           },
// //           style: "road", // You can use 'satellite', 'hybrid', 'road', etc.
// //         });
...
// //               <h4>${cam.name || `Camera ${cam.id}`}</h4>
// //               <p>Location: ${cam.lat}, ${cam.lng}</p>
// //             </div>`,
// //             pixelOffset: [0, -18]
// //           });
...
// //           mapInstance.current.markers = mapInstance.current.markers || new atlas.HtmlMarkerManager(mapInstance.current);
// //           mapInstance.current.markers.add(marker);

// //           markersRef.current.push(marker);
// //         } catch (error) {
// //           console.error(`Error adding marker for camera ${cam.id}:`, error);
// //         }
// //       });

// //       console.log(`Added ${cameraLocations.length} camera markers to the map`);
// //     }
// //   }, [cameraLocations]);
...
//   // Fetch camera locations from Flask backend
//   useEffect(() => {
//     const fetchCameraLocations = async () => {
//       try {
//         const response = await fetch("http://localhost:5000/camera-locations");
...
//           // ✅ Add directly to map’s built-in marker manager
//           mapInstance.current.markers.add(marker);
